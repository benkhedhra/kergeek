...
public class CreationTables {
	...
	static public void main (String argv[]) throws SQLException,ClassNotFoundException {
		...
		try{
			...
			s.executeUpdate("insert into Compte values(seqCompte.nextval,'chacal','Repartout','Didier','45 boulevard du cambouis 59 000 Lille', 'didierrepartout@gmail.com', '1', '0','2')");
			s.executeUpdate("insert into Compte values(seqCompte.nextval,'castor','Debrouille','Jacky','26 allée de la vidange 57 000 Metz', 'jackydebrouille@gmail.com', '1', '0','2')");
			
			
			// Insertion lieus
			s.executeUpdate("insert into Lieu values(seqLieu.nextval,'Gare du Campus','15','1')");
			s.executeUpdate("insert into Lieu values(seqLieu.nextval,'Forum du Campus','10','1')");
			s.executeUpdate("insert into Lieu values(seqLieu.nextval,'ENSAI','10','1')");
			s.executeUpdate("insert into Lieu values(seqLieu.nextval,'Garage','1000','2')");
			
			/*
			// Insertion velos
			s.executeUpdate("insert into Velo values(seqVelo.nextval,'0')");
			s.executeUpdate("insert into Velo values(seqVelo.nextval,'0')");
			s.executeUpdate("insert into Velo values(seqVelo.nextval,'1')");
			
			
			//Insertion demande intervention
			s.executeUpdate("insert into DemandeIntervention values(seqDemandeIntervention.nextval,"+"TO_DATE('06-11-2009 9:18','DD-MM-YYYY HH24:MI'))");
			s.executeUpdate("insert into DemandeIntervention values(seqDemandeIntervention.nextval,"+"TO_DATE('21-11-2009 9:18','DD-MM-YYYY HH24:MI'))");
			*/
			...
			s.executeUpdate("insert into Intervention values(seqIntervention.nextval,"+"TO_DATE('06-11-2009 9:18','DD-MM-YYYY HH24:MI'))");
			s.executeUpdate("insert into Intervention values(seqIntervention.nextval,"+"TO_DATE('19-12-2009 9:18','DD-MM-YYYY HH24:MI'))");
			s.executeUpdate("insert into Intervention values(seqIntervention.nextval,"+"TO_DATE('01-09-2009 9:18','DD-MM-YYYY HH24:MI'))");
			
			
			//Insertion demandes assignation
			s.executeUpdate("insert into DemandeAssignation values(seqDemandeAssignation.nextval,"+"TO_DATE('23-11-2009 15:18','DD-MM-YYYY HH24:MI'),'0','5')");
			s.executeUpdate("insert into DemandeAssignation values(seqDemandeAssignation.nextval,"+"TO_DATE('04-11-2009 10:13','DD-MM-YYYY HH24:MI'),'1','4')");
