	 ...
	 */	private Emprunt empruntEnCours;
	 ...
	 public boolean equals(Object o) {
		 ...
		 if(this.getEmpruntEnCours() == null){
			 ...
			 Boolean ea = false;
			 Boolean eb = false;
			 Emprunt e1 = this.getEmpruntEnCours();
			 if( !(u.getEmpruntEnCours() == null)){
				 Emprunt e2 = u.getEmpruntEnCours();
				 if(e1.getId() == null){
					 ea = e2.getId() == null;
				 }
				 else{
					 ea = e1.getId().equals(e2.getId());
				 }
				 if(e1.getDateRetour() == null){
					 eb = e2.getDateRetour() == null && e2.getStationRetour() == null;
				 }
				 else{
					 eb = (e1.getDateRetour().equals(e2.getDateRetour())) && (e1.getStationRetour().equals(e2.getStationRetour()));
				 }
					Boolean va = false;
					Boolean vb = false;
					Velo v2 = e2.getVelo();
					...
					if (v1.getId() == null){
						...
						va = v1.getId().equals(v2.getId());
					}
					vb = va && (v1.getLieu().equals(v2.getLieu())) && (v1.isEnPanne()== v2.isEnPanne());
				 
				 e = vb && ea && eb && (e1.getDateEmprunt().equals(e2.getDateEmprunt()))  && (e1.getStationEmprunt().equals(e2.getStationEmprunt()));
			 }
		 }
