...
/**
 * La classe Lieu est une classe abstraîte qui reprÈsente les différents lieus dans lesquels peut être placÈ un VÈlo.
 * @see Detruit
 * @see Garage
 * @see Sortie
 * @author KerGeek
...
public abstract class Lieu {
	...
	/**
	 * Le nombre maximum de VÈlo pouvant contenir ce Lieu. {@link Sortie} et {@link Detruit} n'ont pas cette limite,
	 ...
	 * @return un booléen
	 * qui vaut vrai si les deux instances de la classe Lieu ont les mÍmes valeurs pour chacun de leurs attributs,
	 * faux sinon
	 */
	@Override
