...
public class Intervention {
	...
	/**
	 * Le {@link Velo} concerné par l'Intervention.
	...
	/**
	 * Constructeur par défaut d'une Intervention.
	 */
	public Intervention() {
		super();
	}
	...
	/**
	 * Création d'un Emprunt à partir des éléments suivants : {@link Intervention#velo} et {@link Intervention#date}.
	 * @param velo
	 * @param date
	 */
	...
	/**
	 * Création d'un Emprunt à partir des éléments suivants : {@link Intervention#velo}, {@link Intervention#date} et {@link Intervention#typeIntervention}.
	 * @param velo
	 * @param date
	 ...
	 * @return vrai si les deux instances de la classe Intervention ont les mêmes valeurs pour chacun de leurs attributs,
	 * faux sinon
	 */
	@Override
