...
/**
 * La classe DemandeAssignation reprÈsente les demandes d'assignation faÓtes par un {@link Administrateur} lorsqu'il y a trop
 * ou trop peu de vÈlo dans un {@link Lieu}. Le sytËme dÈterminera ensuite s'il s'agit d'un ajout ou d'un retrait.
...
public class DemandeAssignation {
	...
	/**
	 * L'identifiant d'une demandeAssignation est unique. Une fois attribuÈ, il ne doit pas Ìtre modifiÈ
	...
	/**
	 * La date ‡ laquelle la DemandeAssignation ‡ ÈtÈ faÓte
	...
	/**
	 * Le nombre de vÈlos souhÈaÓtÈ dans le lieu, qui sera comparÈ avec le nombre de vÈlos dans le lieu en question
	...
	/**
	 * Le lieu où la demande d'assignation est faÓte
	...
	/**
	 * CrÈation d'une DemandeAssignation ‡ partir d'un {@link DemandeAssignation#nombreVelosVoulusDansLieu}
	 * et d'un {@link DemandeAssignation#lieu}, la {@link DemandeAssignation#date} est initialisÈe ‡ la date systËme
	 ...
	 * @param nombreVelos
	 * le nombre de vÈlos souhaÓtÈ dans le lieu 
	 */
	 ...
	 * @return vrai si les deux instances de la classe DemandeAssignation ont les mÍmes valeurs pour chacun de leurs attributs,
	 * faux sinon
	 */
	@Override
