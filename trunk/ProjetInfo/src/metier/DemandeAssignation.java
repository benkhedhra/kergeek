...
public class DemandeAssignation {
	...
	/**
	 * La date à laquelle la DemandeAssignation ‡ ÈtÈ faÓte
	...
	/**
	 * Le nombre de vÈlos souhÈaÓtÈ dans le lieu, qui sera comparÉ avec le nombre de vÈlos dans le lieu en question
