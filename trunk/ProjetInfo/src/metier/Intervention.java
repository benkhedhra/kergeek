...
public class Intervention {
	 ...
	 * @return vrai si les deux instances de la classe Intervention ont les mÍmes valeurs pour chacun de leurs attributs,
	 * faux sinon
	 */
	@Override
	...
	/**
	 * @return l'identifiant de l'intervention suivi du vÈlo concernÈ
	 */
	@Override
	public String toString(){
		return "Intervention "+this.getId()+" - vÈlo "+this.getVelo().getId();
