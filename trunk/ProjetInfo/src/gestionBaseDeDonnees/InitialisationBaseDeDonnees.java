...
/**
 * Rassemble les mÈthodes static permettant d'initialiser la base de donnÈes necessaire au fonctionnement de l'application.
 * @see CreationTables
 * @author KerGeek
 */
public class InitialisationBaseDeDonnees {
	...
	/**
	 * CrÈation des tables où seront stockÈes les informations necessaires au fonctionnement de l'application, 
	 * et des sÈquences SQL que celles-ci utilisent.
	 * @throws SQLException
	...
	/**
	 *Insertion des donnÈes de tests dans la base de donnÈes.
	 * @throws SQLException
	 * @throws ClassNotFoundException
	 * @throws ConnexionFermeeException
	 */
	public static void insertionDonneesTests() throws SQLException,ClassNotFoundException, ConnexionFermeeException {
		...
		try{
			...
			s2.executeUpdate("insert into TypeIntervention values('" + TypeIntervention.TYPE_NON_JUSTIFIEE + "','demande non justifiÈe')");
			...
			System.out.println("Update effectuÈ.");
	...
	/**
	 * Suppression des tables et des sÈquences SQL
	 * prÈalablement crÈÈes au moyen de la mÈthode {@link InitialisationBaseDeDonnees#creationTables()},
	 * dans l'ordre inverse de leur crÈation.
	 * @throws SQLException
	 * @throws ClassNotFoundException
	 * @throws ConnexionFermeeException
	 */
