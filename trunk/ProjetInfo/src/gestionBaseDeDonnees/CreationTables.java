...
public class CreationTables {
	...
	static public void main (String argv[]) throws SQLException,ClassNotFoundException {
		...
		try{
			...
			s.executeUpdate("insert into Compte values(CONCAT('2',seqTechnicien.nextval),'castor','Debrouille','Jacky','26 allée de la vidange 57 000 Metz', 'jackydebrouille@gmail.com', '1', '0','2')");
