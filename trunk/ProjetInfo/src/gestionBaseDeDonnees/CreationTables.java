...
public class CreationTables {
	...
	static public void main (String argv[]) throws SQLException,ClassNotFoundException {
		...
		s.executeUpdate(
				...
				"CONSTRAINT fk_Intervention_TypeIntervention FOREIGN KEY(idTypeIntervention) REFERENCES TypeIntervention," +
		...
		s.executeUpdate("insert into Compte values('1001','lapin','Ker','Geek','Ensai 35 172 Bruz', 'kergeek@gmail.com', '1', '0','1')");
		// Insertion utilisateurs
		s.executeUpdate("insert into Compte values('3001','kangourou','Vincent','Francky','69 rue de la passion 75 001 Paris', 'franckyvincent@gmail.com', '1', '0','3')");
		s.executeUpdate("insert into Compte values('3002','koala','Chedid','Mathieu','10 rue Machistador 17 000 La Rochelle', 'mathieuchedid@gmail.com', '1', '0','3')");
		s.executeUpdate("insert into Compte values('3003','bison','Brassens','Georges','1 square des copains 34 000 Sete', 'georgesbrassens@gmail.com', '1', '0','3')");
		s.executeUpdate("insert into Compte values('3004','putois','Marley','Bob','6 rue Marie-Jeanne 13 000 Marseille', 'bobmarley@gmail.com', '1', '0','3')");
		s.executeUpdate("insert into Compte values('3005','fouine','Hilton','Paris','12 avenue de la pouf 06 400 Cannes', 'parishilton@gmail.com', '1', '0','3')");
